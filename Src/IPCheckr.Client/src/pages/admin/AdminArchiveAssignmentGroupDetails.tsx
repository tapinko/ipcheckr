...
const AdminArchiveAssignmentGroupDetails = () => {
  const navigate = useNavigate()
  return (
    <AGAssignmentGroupDetailsFeature
      onNavigateSubmitDetails={(agId, assignmentId, type) => navigate(getParametrizedUrl(RouteKeys.ADMIN_ASSIGNMENT_GROUPS_ARCHIVE_DETAILS_SUBMIT, {
...
export default AdminArchiveAssignmentGroupDetails